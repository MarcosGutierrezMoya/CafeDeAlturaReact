                ...
                <div id="secTittle" className='flex gap-6'>
                    <article className='flex flex-col items-start gap-4 w-588'>
                        ...
                        <div className='text-white flex flex-row gap-4 text-14'>
                            <input type="button" value="Descubrir Orígenes" className='bg-tittleBtnBlack basis-1/5 px-24px py-12px rounded-4px drop-shadow-buttons'/>
                            <input type="button" value="Comprar café" className='bg-green basis-1/5 px-24px py-12px rounded-4px drop-shadow-buttons'/>
                        </div>
                    </article>
