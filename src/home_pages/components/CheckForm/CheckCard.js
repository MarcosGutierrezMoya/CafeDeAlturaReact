...
function CheckCard() {
    ...
    return(
        <div className="flex flex-col items-start">
            <label htmlFor="userPhone" className='text-12'>Número de la tarjeta</label>
            <input type="number" id="userPhone" name="userPhone" onInput={checkUserTlf} required placeholder="1234 1234 1234 1234" className={`border ${valid===0?"border-inputBorder":valid===1?"border-green":"border-red"} px-13px py-9px rounded-6px shadow-sm outline-none text-12 w-full`} ref={userPhone}/>
